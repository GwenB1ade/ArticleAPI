...
from schemas.user_schemas import CreateUserSchema, ViewUserSchema, UserSchema, LoginUserSchema
...
async def token(
    ...
    user = UserService.login_user_by_username(
        username = username,
        password = password
    )
