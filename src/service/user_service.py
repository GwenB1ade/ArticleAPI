...
from schemas.user_schemas import CreateUserSchema, UserSchema, ViewUserSchema, LoginUserSchema
...
class UserService(BaseServices):
    ...
    def create_user(cls, data: CreateUserSchema) -> UserModel:
        ...
        with session_creater() as s:
            ...
            if user:
                raise HTTPException(
                    status_code = 400,
                    detail = 'There is a user with such an email address'
                )
    ...
    def login_user(cls, login_data: LoginUserSchema):
        ...
        with session_creater() as s:
            ...
            raise HTTPException(
                status_code = 400,
                detail = 'Invalid password or email address'
            )
    ...
    @classmethod
    def change_username(cls, new_username: str, email: str = None, uuid: str = None) -> None:
